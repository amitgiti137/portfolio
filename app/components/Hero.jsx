...
export default function Hero() {
    return (
        <section className="w-[100%] container mx-auto rounded-xl lg:rounded-4xl flex flex-col justify-center items-center bg-gradient-to-r from-[#89A8B2] via-[#47663B] to-[#B6A28E] text-white py-6 relative">
