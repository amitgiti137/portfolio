...
export default function Header({ setActiveSection }) {
    return (
        <section className='conatiner mx-auto'>
            <header className="bg-gradient-to-r from-[#A6AEBF] via-[#D4F6FF] to-[#FFF9BF] flex justify-between items-center py-3 px-10 bg-white dark:bg-gray-600 shadow-md fixed top-0 left-0 w-full z-20 ">
